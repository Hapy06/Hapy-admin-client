...
function PreparationModalPerte(props:PropsType) {
        ...
        {loseValidated ? (
                <div className="hapy-modal">
                    ...
                    <svg width="128" height="128" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M107.04 101.547L95.7334 90.2935" stroke="#F7B927" strokeWidth="5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M106.934 90.4536L95.627 101.707" stroke="#F7B927" strokeWidth="5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                    </div>
                    ...
                    <HapyButtonWithIcon text="Retour à votre interface" handleClick={()=>{props.handleCloseModal ;  navigate('/preparation')}}
                ...
                <div className="hapy-modal">
                    ...
                    <div className="text-start">
                         <span className="text-orange mr-4 fw-6">2</span> Oeuf
                    </div>
                    <br/>
                    <div>
                         <span className="text-orange mr-4 fw-6">2</span> Tomates
                    </div>
                    <br/><br/><br/><br/><br/><br/><br/>
                    <HapyButtonWithIcon text="Valider la perte" handleClick={()=>setLoseValidated(true)}
                                        numberAtEnd={4} numberAtEndColor={"#FF6063"} iconComponent={<IconLose/>}/>
                </div>
            )}
        </>
    )
}
export default PreparationModalPerte
