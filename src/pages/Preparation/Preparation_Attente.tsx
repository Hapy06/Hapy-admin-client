...
import Preparation_Top, {screenHeight} from "./Preparation_Top";
...
import IconTimer3 from "../../globals/icons-components/IconTimer3";
...
function Preparation_Attente(props:PropsType) {
  ...
  const handleClickPause = () => {
    ...
    } else { // Luc decide de rendre le bouton pause non cliquable si la commande est en pause
          ...
          <div className={"preparation-container-wrapper " + blurBG}>
            ...
            <div className="row">
              ...
              <div className="col-lg-6 col-md-4">
                ...
                <div className="col-lg-12 vertical-center" style={{height:screenHeight-400}}>
                    <div>
                        ...
                        <div className="float-end" style={{marginTop:64}}>
                            <HapyButtonWithIcon btnClass="bg-orange" handleClick={handleClickValidate}
                                                iconComponent={<IconVerify/>}
                                                text={"Valider"} btnWidth={366}/>
                        </div>
                    </div>
                </div>
                  <div style={{right:32, bottom:32, position:"absolute"}}>
                      <HapyButtonWithIcon text="Retour à votre gestion" handleClick={() => {
                          navigate('/preparation')
                      }}
                                          btnWidth={366}
                                          iconComponent={<IconArrowLeft classIcon={"mt-2"} width={32}
                                                                        height={32}/>}/>
                  </div>
              </div>
            </div>
