...
import {BASE_URL, getAdminProcessValues, setProcessStored} from "../../globals/GlobalVariables";
...
function Preparation_Home(props:PropsType) {
    ...
    const [loadMessageNotif, setLoadMessageNotif] = useState<string>("(Pas de commandes en cours)");
                        ...
                        <div className="col-lg-3 col-md-4">
                            ...
                            {preparationProcess.orderCooking && (
                                <PreparationCurrentCommandRed order={preparationProcess.orderCooking} handleClick={()=>handleOrderClicked(preparationProcess.orderCooking)}/>
                            )}
                        </div>
                        ...
                        <div className="col-lg-6 col-md-4">
                            <div className="col-lg-5 col-md-12 float-end row">
                                ...
                                <div className="col-4">
                                        ...
                                        <span className="fw-8">{preparationProcess.ticketQuantity}</span>
                                        <span style={{marginLeft:4}}>
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
